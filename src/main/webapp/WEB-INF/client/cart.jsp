                ...
                <div class="col-lg-6">
                    <div class="shoping__continue" style="margin-top: 30px">
                        <div class="row">
                            ...
                            <div class="col-lg-6"><span><a
                                    href="#"
                                    class="apply"><span style="color: #6fa6d6;"
                                                        id="voucher-input">Chọn hoặc nhập mã <i class="fa fa-plus"></i></span></a></span></div>
                ...
                <div class="col-lg-6" style="margin-left: 580px">
                    <div class="shoping__checkout" style="background-color: #f5f5f5">
                        ...
                        <ul>
                            ...
                            <li>Giảm giá<span id="discountAmount" name="discountAmount"></span></li>
