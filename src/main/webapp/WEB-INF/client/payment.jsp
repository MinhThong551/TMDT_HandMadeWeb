...
<%--                                    <div class="order-info">Mã đơn hàng: <span class="data">${order.id}</span></div>--%>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order" style="width: 400px">
                            ...
                            <div class="checkout__order__total">Tổng tiền hàng<span id="total"><fmt:formatNumber value="${order.totalMoney}"
                                                                                                      pattern="#,###.### ₫"/></span></div>
                            ...
                            <div class="checkout__order__total">Voucher từ shop<span><fmt:formatNumber value="${discount}"
                                                                                                       pattern="#,###.### ₫"/></span></div>
                            <div class="checkout__order__total">Thành tiền<span id=""><fmt:formatNumber value="${order.totalMoney + order.ship - discount}"
